...
@section('content')
    <form action="{{ route('ReportePdfProductosMasComprados') }}" method="GET" id="reporteForm">
        <div class="card">
            <div class="card-header" style="background-color: #3498db; color: white; border-top-left-radius: 8px; border-top-right-radius: 8px; padding: 10px;">
                <h3 class="card-title">Reporte de Productos Más Comprados</h3>
            </div>
            <div class="card-body">
                <div class="form-row">
                    <div class="form-group col-md-3">
                        <label for="search_id_producto">Buscar por ID de Producto:</label>
                        <input type="text" class="form-control" id="search_id_producto">
                    </div>
                </div>
                <div class="table-responsive">
                    <table id="productosmascomprados" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $reporte->total_importe_vendido }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                        <tfoot>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            var table = $('#productosmascomprados').DataTable({
                "paging": false,
                "info": false,
