...
@section('title', 'Productos Más Devueltos')
...
@section('content')
    <form action="{{ route('ReportePdfProductosMasDevueltos') }}" method="GET" id="reporteForm">
        <div class="card">
            <div class="card-header" style="background-color: #3498db; color: white; border-top-left-radius: 8px; border-top-right-radius: 8px; padding: 10px;">
                <h3 class="card-title">Reporte de Productos Más Devueltos</h3>
            </div>
            <div class="card-body">
                <div class="form-row">
                ...
                <div class="table-responsive">
                    <table id="productosmasdevueltos" class="table table-bordered table-hover">
                        <thead>
                            <tr>
